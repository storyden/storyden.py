...
pip install git+ssh://git@github.com/storyden/storyden.py.git
```
...
```sh
# install from the production repo
pip install 'Storyden[aiohttp] @ git+ssh://git@github.com/storyden/storyden.py.git'
```
...
These methods return an [`APIResponse`](https://github.com/storyden/storyden.py/tree/main/src/Storyden/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/storyden/storyden.py/tree/main/src/Storyden/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/storyden/storyden.py/issues) with questions, bugs, or suggestions.
