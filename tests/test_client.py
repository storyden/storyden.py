...
def _get_open_connections(client: Storyden | AsyncStoryden) -> int:
...
class TestStoryden:
    ...
    def test_multipart_repeating_array(self, client: Storyden) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Storyden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Storyden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Storyden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Storyden) -> None:
        respx_mock.get("/version").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.misc.version.with_streaming_response.retrieve().__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("Storyden._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Storyden) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Storyden, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.misc.version.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.misc.version.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncStoryden:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncStoryden) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncStoryden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncStoryden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncStoryden) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncStoryden
    ) -> None:
        respx_mock.get("/version").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.misc.version.with_streaming_response.retrieve().__aenter__()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncStoryden, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.misc.version.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from Storyden._utils import asyncify
        from Storyden._base_client import get_platform
