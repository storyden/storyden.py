...
from Storyden import Storyden, AsyncStoryden, DefaultAioHttpClient
from Storyden._utils import is_dict
...
def client(request: FixtureRequest) -> Iterator[Storyden]:
    ...
    with Storyden(base_url=base_url, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncStoryden]:
    ...
    async with AsyncStoryden(base_url=base_url, _strict_response_validation=strict, http_client=http_client) as client:
        yield client
