...
class TestMake:
    ...
    def test_method_create(self, client: Storyden) -> None:
        make = client.auth.webauthn.make.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
        )
        assert_matches_type(MakeCreateResponse, make, path=["response"])
    ...
    def test_raw_response_create(self, client: Storyden) -> None:
        response = client.auth.webauthn.make.with_raw_response.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
    ...
    def test_streaming_response_create(self, client: Storyden) -> None:
        with client.auth.webauthn.make.with_streaming_response.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
    ...
    def test_method_retrieve(self, client: Storyden) -> None:
        make = client.auth.webauthn.make.retrieve(
            "Southclaws",
        )
        assert_matches_type(MakeRetrieveResponse, make, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Storyden) -> None:
        response = client.auth.webauthn.make.with_raw_response.retrieve(
            "Southclaws",
        )
    ...
    def test_streaming_response_retrieve(self, client: Storyden) -> None:
        with client.auth.webauthn.make.with_streaming_response.retrieve(
            "Southclaws",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Storyden) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_handle` but received ''"):
            client.auth.webauthn.make.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncMake:
    ...
    async def test_method_create(self, async_client: AsyncStoryden) -> None:
        make = await async_client.auth.webauthn.make.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
    ...
    async def test_raw_response_create(self, async_client: AsyncStoryden) -> None:
        response = await async_client.auth.webauthn.make.with_raw_response.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        make = await response.parse()
        assert_matches_type(MakeCreateResponse, make, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncStoryden) -> None:
        async with async_client.auth.webauthn.make.with_streaming_response.create(
            id="id",
            raw_id="rawId",
            response={"client_data_json": "clientDataJSON"},
            type="type",
    ...
    async def test_method_retrieve(self, async_client: AsyncStoryden) -> None:
        make = await async_client.auth.webauthn.make.retrieve(
            "Southclaws",
        )
        assert_matches_type(MakeRetrieveResponse, make, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncStoryden) -> None:
        response = await async_client.auth.webauthn.make.with_raw_response.retrieve(
            "Southclaws",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncStoryden) -> None:
        async with async_client.auth.webauthn.make.with_streaming_response.retrieve(
            "Southclaws",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncStoryden) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_handle` but received ''"):
            await async_client.auth.webauthn.make.with_raw_response.retrieve(
                "",
            )
