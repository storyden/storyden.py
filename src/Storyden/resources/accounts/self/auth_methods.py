...
from ....types.accounts.self.auth_method_list_response import AuthMethodListResponse

from ...._base_client import make_request_options

from ....types.accounts.self.auth_method_delete_response import AuthMethodDeleteResponse
